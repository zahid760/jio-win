        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <form action="{{ route('notification.update', $data->id) }}" method="post" id="submit-form">
                        @csrf
                        @method('PUT')
                        <div class="row g-2">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="description" placeholder="Enter description" value="{{$data->description}}" required="">
                            </div>
                            <div class="col-md-12">
