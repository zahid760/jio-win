            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title">Partner Update</h4>
                        </div>
                    </div>
                </div>

                <div class="card-body pt-0">
                    <form action="{{ route('partner.update', $data->id) }}" method="post" id="submit-form">
                        @csrf
                        @method('PUT')
                        <div class="row g-2">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="mobile" minlength="2" maxlength="10" placeholder="Enter mobile number" value="{{$data->mobile}}" required="">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Password <span class="text-danger">*</span></label>
                                <input type="password" class="form-control" name="password" minlength="2" maxlength="8" placeholder="Enter password">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Confirm Password <span class="text-danger">*</span></label>
                                <input type="password" class="form-control" name="password_confirmation" minlength="2" maxlength="8" placeholder="Enter password">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="MATKA_GAME" id="matka_game" name="game_permissions[]" {{ $data->hasPermissionTo('MATKA_GAME') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="matka_game">Matka Game</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="SATTA_GAME" id="satta_game" name="game_permissions[]" {{ $data->hasPermissionTo('SATTA_GAME') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="satta_game">Satta Game</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="COLOR_GAME" id="color_game" name="game_permissions[]" {{ $data->hasPermissionTo('COLOR_GAME') ? 'checked' : '' }}>
