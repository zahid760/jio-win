                ...
                <div class="col-12">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-3 active show" id="special-mode" role="tabpanel">
                            <form action="{{ route('satta.jodi.store') }}" method="POST" id="single-digit-special-form">
                                @csrf
                                @method('POST')
                                <input type="hidden" name="game_id" value="{{ $game->id }}">
                                <input type="hidden" name="game_mode" value="{{ $mode_id }}">
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="game_mode" class="form-select">
                                            <option value="18">Andar Ka Haruf</option>
                                            <option value="17">Bahar Ka Haruf</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    @for ($i = 0; $i <= 9; $i++)
                                        <div class="col-6">
                                            <div class="input-group">
                                                <div class="input-group-text bg-danger text-white">{{ $i.$i.$i }}</div>
                                                <input type="number" class="form-control" name="game_no[]" placeholder="Andar">
                                            </div>
                                        </div>
                                    @endfor
                                </div>
...
@section('pagescript')
    <script>
        $(document).on('change', '[name="game_mode"]', function(){
            let value = $(this).val();
            $('[name="game_no[]"]').attr('placeholder', value == '17' ? 'Bahar' : 'Andar');
        });
                ...
                if (value >= 1) {
                    html +=`<div class="card mb-1">
                                <div class="card-body p-1">
                                    <div class="row">
                                        <div class="col-6 text-center">${index}</div>
