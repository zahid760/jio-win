                        ...
                        <div class="tab-pane p-3 active show" id="special-mode" role="tabpanel">
                            <form action="{{ route('satta.jodi.store') }}" method="POST" id="jodi-special-form">
                                ...
                                <div class="row gy-2 my-2">
                                    @php $arr = [00, 11, 22, 33, 44, 55, 66, 77, 88, 99] @endphp
                                    @for ($i = 0; $i <= 99; $i++)
                                        @if(!in_array($i,$arr))
                                            <div class="col-6">
                                                <div class="input-group">
                                                    <div class="input-group-text bg-danger text-white">{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</div>
                                                    <input type="number" class="form-control game_no" name="game_no[{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}]">
                                                </div>
                                            </div>
                                        @endif
                                    @endfor
                ...
                if (value >= 1) {
                    rowhtml +=`<div class="card mb-1">
                                <div class="card-body p-1">
                                    <div class="row">
                                        <div class="col-6 text-center">${index.toString().padStart(2, '0')}</div>
